...
class Player(GameSprite):
    ...
    def fire(self):
        bullet = Bullet('bullet.jpg', self.rect.right, self.rect.centery, 15, 20, 15)#зачем эти числа№№№№№
        bullets.add(bullet)
...
w1 = GameSprite('1.jpg',win_width / 2 - win_width / 3, win_height / 2, 300, 50)
w2 = GameSprite('1.jpg', 370, 100, 50, 400)
...
#создаем спрайты
packman = Player('3.jpg', 5, win_height - 80, 80, 80, 0, 0)
final_sprite = GameSprite('3.jpg',   win_width - 85, win_height - 100, 80, 80)

monster = Enemy('2.jpg',  win_width - 80, 150, 80, 80, 5)
monster2 = Enemy('2.jpg',  win_width - 80, 230, 80, 80, 5)
...
finish = False
win = transform.scale(image.load('5.jpg'), (700,500))
loos = transform.scale(image.load('5.jpg'), (700,500))
while run:
    ...
    '''
        ...
        if sprite.collide_rect(packman, monster):
            ...
            window.blit(transform.scale(loos, (win_width, win_height)), (0, 0))           
            display.update()
            sleep (10)
            #load lose pic
